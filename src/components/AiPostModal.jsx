...
import { createGMBSchedulePost } from 'app/gmbSlice/schedulePost';
...
function AIPostModal({ setIsOpen1, isOpen, keywords }) {
            ...
            content: <>
                <div className="mt-4">
                    {loading1 == true ? <div className='d-flex justify-content-center align-items-center mt-5'><Spin /></div> : <>
                        {error == true ? <Alert type="error" description="Something went wrong while generating content"></Alert> : <>
                            <Alert description="The image will be generated automatically by AI. If you want to change it, upload your own image"></Alert>
                            <div className='mb-5'>
                                <Formik
                                    initialValues={{
                                        avatar: image,
                                    ...
                                    onSubmit={(values) => {
                                        ...
                                        dispatch(createGMBSchedulePost(formData)); 
                                    }}
                                            ...
                                            <div className="row">
                                                <div className="col-md-8">
                                                    <div className="mt-4">
                                                        ...
                                                        <p>Posts that include graphics have a higher chance of drawing in readers. For a Google business profile article, 1200 x 900 pixels is the ideal image size, with an aspect ratio of 4:3.</p>
                                                        <Field name="avatar">
                                                            {({ field }) => (
